...
const UserCreateModal = (props: any) => {
    ...
    const isCreatingSuccess = useAppSelector((state) => state.user.isCreatingSuccess);
    ...
    }, [isCreatingSuccess, setIsOpenCreateModal]);
        ...
        <>
            ...
            >
                ...
                <Modal.Footer>
                    {isCreating === false ? (
                        <>
                            <Button variant='warning' onClick={() => setIsOpenCreateModal(false)} className='mr-2'>Cancel</Button>
